...
public class WelcomePanel extends JPanel {
    ...
    private JPanel createInputCard() {
        ...
        card.setPreferredSize(new Dimension(450, 390));
        ...
        validationLabel.setFont(BattleshipGUI.SMALL_FONT);
        validationLabel.setForeground(BattleshipGUI.HIT_COLOR);
        ...
        card.add(Box.createRigidArea(new Dimension(0, 23)));
    ...
    private boolean validatePlayerNames(String p1, String p2) {
        if (p1.isEmpty() && p2.isEmpty()) {
            showValidationError("Bitte beide Spielernamen eingeben.", player1Field);
            return false;
        }
        if (p1.isEmpty()) {
            showValidationError("Bitte den Namen fuer Spieler 1 eingeben.", player1Field);
            return false;
        }
        if (p2.isEmpty()) {
            showValidationError("Bitte den Namen fuer Spieler 2 eingeben.", player2Field);
            return false;
        }
        if (p1.equalsIgnoreCase(p2)) {
            showValidationError("Bitte zwei unterschiedliche Namen eingeben.", player2Field);
            return false;
        }
    ...
    private void showValidationError(String message, ModernTextField fieldToFocus) {
